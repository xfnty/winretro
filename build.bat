...
set "libraries=kernel32 user32 comdlg32 comctl32 gdi32 shell32"
...
set cflags=/nologo /options:strict /Wall /wd4711 /wd5045 /wd4820 /Oi- /GS- /fp:fast /I %src%.
set lflags=/nodefaultlib /entry:main /subsystem:windows
if "%dist%"=="1" (
